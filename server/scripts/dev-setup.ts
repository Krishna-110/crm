...
async function main() {
  ...
  //
  // db/seed.sql now carries real bcrypt digests, so a freshly seeded database already
  // accepts these credentials. This step is kept as a recovery path for a database whose
  // passwords have since been changed by hand or by testing.
